...
<databrowser>
    ...
    <pvlist>
        <pv>
            <display_name>$(PS):READ_PFLD</display_name>
            <visible>true</visible>
            <name>$(PS):READ_PFLD</name>
            <axis>0</axis>
            <color>
                <red>255</red>
                <green>0</green>
        ...
        <pv>
            <display_name>$(PS):READ_FSET</display_name>
            <visible>true</visible>
            <name>$(PS):READ_FSET</name>
            <axis>0</axis>
            <color>
                <red>0</red>
                <green>255</green>
        ...
        <pv>
            <display_name>$(PS):FieldSet</display_name>
            <visible>true</visible>
            <name>$(PS):FieldSet</name>
            <axis>0</axis>
            <color>
                <red>255</red>
                <green>127</green>
